    ...
    return (
      <div className="min-h-screen bg-background px-6 py-14">
        <div className="mx-auto max-w-xl rounded-3xl border border-border bg-card p-8 text-center shadow-sm sm:p-10">
          ...
          <p className="mx-auto mt-4 max-w-md text-sm leading-6 text-muted-foreground">The marketplace preview is free to browse and does not require payment information. Full Quarry Intelligence opens the complete record behind every site: mapped parcel and ownership intelligence, geology and rock type, permits and compliance history, production context, opportunity screening and premium analysis.</p>
          ...
          <div className="mt-7 flex flex-col items-center justify-center gap-3 sm:flex-row sm:flex-wrap">
            <Link to={subscribeHref} className="inline-flex items-center gap-2 rounded-xl bg-slate-900 px-5 py-3 text-sm font-bold text-white"><Crown className="h-4 w-4" />Start 3-Day Free Trial</Link>
          ...
          <p className="mt-5 text-xs leading-5 text-muted-foreground">Trial access unlocks the full app. After 3 days, the membership is $199/month unless cancelled. Custom reports and due-diligence research are separate professional services.</p>
        </div>
      </div>
    );
  }

      ...
      <div className="min-h-screen bg-background px-6 py-14">
        <div className="mx-auto max-w-xl rounded-3xl border border-border bg-card p-8 text-center shadow-sm sm:p-10">
          ...
          <div className="mt-7 flex flex-col items-center justify-center gap-3 sm:flex-row sm:flex-wrap">
            <Link to={subscribeHref} className="inline-flex items-center gap-2 rounded-xl bg-slate-900 px-5 py-3 text-sm font-bold text-white"><Crown className="h-4 w-4" />Subscribe for $199/Month</Link>
          ...
          <p className="mt-5 text-xs leading-5 text-muted-foreground">The membership is $199/month and renews automatically until canceled. On iPhone, Apple confirms the price before purchase and no S&amp;S account is required. Custom reports and due-diligence research are separate professional services.</p>
        </div>
      </div>
    );
  }

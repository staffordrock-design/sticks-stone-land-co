...
export default function SellProperty() {
  ...
  return <div className="min-h-screen bg-background">
    ...
    <main className="mx-auto max-w-4xl px-6 py-10">
      <div className="mb-8"><p className="text-xs uppercase tracking-[0.2em] text-muted-foreground">For Sellers</p><h1 className="mt-2 font-heading text-3xl font-bold">List Your Quarry or Property</h1><p className="mt-3 max-w-2xl text-sm text-muted-foreground">Create a seller listing for an operating quarry, aggregate operation, quarry-capable property, mineral interest or royalty interest. S&S reviews the submission before it is marketed.</p></div>

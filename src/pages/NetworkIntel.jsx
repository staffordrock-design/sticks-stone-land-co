      ...
      <main className="mx-auto max-w-7xl px-4 py-5 sm:px-6">
        ...
        {selectedCompany && <section className="mt-5 rounded-3xl border border-sky-200 bg-card p-5 shadow-lg sm:p-6">
          ...
          <div className="mt-5 flex flex-wrap gap-2">
            ...
            {members.some((member) => companyKey(member.company) === selectedCompany.key) && <Link to="/network?tab=people" className="inline-flex items-center gap-2 rounded-xl border border-border px-4 py-2.5 text-xs font-bold"><Users className="h-4 w-4"/>Network members at company</Link>}
          </div>

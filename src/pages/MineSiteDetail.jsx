      ...
      <main className="mx-auto max-w-7xl px-6 py-10">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <div className="mb-8 rounded-3xl border border-sky-200 bg-sky-50/70 p-7 text-center">
            ...
            <button onClick={() => navigate(`/subscribe?returnTo=${encodeURIComponent(`/mines/${id}`)}`)} className="mt-5 rounded-xl bg-slate-900 px-6 py-3 text-sm font-bold text-white shadow-lg">Unlock Full Quarry Intelligence — $49/month</button>

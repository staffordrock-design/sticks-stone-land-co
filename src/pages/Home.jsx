        ...
        <div className="relative mx-auto max-w-7xl px-6 py-20 sm:py-28">
          <div className="max-w-2xl">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <Link to="/subscribe" className="w-full rounded-xl border border-sky-300/60 bg-sky-700/70 px-5 py-3 text-center text-sm font-bold text-white transition hover:bg-sky-600 sm:w-auto">Unlock Full Intelligence — $199/month</Link>
            ...
            <div>
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                <Link to="/subscribe" className="inline-flex min-h-12 items-center gap-2 rounded-xl bg-sky-600 px-6 py-3 text-sm font-bold text-white shadow-lg transition hover:bg-sky-500">
                  <TrendingUp className="h-4 w-4" /> Start for $199/month
                </Link>

    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-4xl px-6 py-12">
        ...
        <div className="space-y-7 text-sm leading-7 text-muted-foreground">
          <p><strong className="text-foreground">Effective date: August 11, 2026.</strong> By using S&S Rock Holdings, you agree to these Terms of Use.</p>
          <section><h2 className="font-heading text-xl font-bold text-foreground">Purpose of the service</h2><p className="mt-2">S&S Rock Holdings provides quarry, mineral, industrial-land, GIS, marketplace, and due-diligence screening tools. The service may combine public, licensed, user-submitted, and derived data to help users research sites and opportunities.</p></section>

    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-4xl px-6 py-12">
        ...
        <div className="space-y-7 text-sm leading-7 text-muted-foreground">
          <p><strong className="text-foreground">Effective date: August 11, 2026.</strong> By using S&S Rock Holdings, a service of S&S Rock Holdings LLC, you agree to these Terms of Use.</p>
          <section><h2 className="font-heading text-xl font-bold text-foreground">Purpose of the service</h2><p className="mt-2">S&S Rock Holdings LLC provides industrial quarry intelligence, GIS, geology, regulatory, ownership, and due-diligence screening tools. The service may combine public, licensed, user-submitted, and derived data to help users research mines, quarries, industrial mineral assets, and related records.</p></section>
          ...
          <section><h2 className="font-heading text-xl font-bold text-foreground">Listings and transactions</h2><p className="mt-2">Unless expressly stated otherwise, S&S Rock Holdings LLC operates a research and intelligence platform and does not guarantee that a property is available, financeable, permitted, mineable, or suitable for a particular use. Owners, operators, buyers, lenders, advisers, and other users remain responsible for their own diligence and agreements.</p></section>

    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-4xl px-6 py-12">
        ...
        <div className="space-y-7 text-sm leading-7 text-muted-foreground">
          ...
          <section><h2 className="font-heading text-xl font-bold text-foreground">Confidential data rooms and NDAs</h2><p className="mt-2">Some materials require a signed NDA and paid access. Confidential documents may not be copied, distributed, published, reverse engineered, or used outside the permitted due-diligence purpose. Access is tied to the authorized user account and may be revoked for misuse.</p></section>

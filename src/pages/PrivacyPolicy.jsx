    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-4xl px-6 py-12">
        ...
        <div className="space-y-7 text-sm leading-7 text-muted-foreground">
          <p><strong className="text-foreground">Effective date: August 11, 2026.</strong> S&S Rock Holdings provides quarry, mineral, industrial-land, GIS, marketplace, and due-diligence tools. This policy explains the information collected when you use our website or app and how it is used.</p>
